...
public class DanhSachBaiHatAdapter  extends RecyclerView.Adapter<DanhSachBaiHatAdapter.ViewHodler> {
    private ArrayList<BaiHat> arrayList;
    private Context context;

    public DanhSachBaiHatAdapter(ArrayList<BaiHat> arrayList, Context context) {
