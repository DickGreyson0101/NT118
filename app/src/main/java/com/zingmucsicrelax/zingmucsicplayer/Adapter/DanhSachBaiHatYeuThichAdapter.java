...
public class DanhSachBaiHatYeuThichAdapter extends RecyclerView.Adapter<DanhSachBaiHatYeuThichAdapter.ViewHodler> {
    private ArrayList<BaiHat> arrayList;
    private Context context;

    public DanhSachBaiHatYeuThichAdapter(ArrayList<BaiHat> arrayList, Context context) {
